...
class PatchPlan(BaseModel):
    ...
    file_changes: list[FileChange] = Field(default_factory=list, validation_alias=AliasChoices("file_changes", "fileChanges", "FileChanges", "patchPlan", "patch_plan", "patches", "changes"))
