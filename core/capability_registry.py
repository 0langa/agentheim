...
def register_workflow(workflow_cls: type, metadata: dict[str, Any] | None = None) -> None:
...
def register_preset(preset_id: str, factory: Callable[..., Any], metadata: dict[str, Any] | None = None) -> None:
    get_registry().register(
        kind="preset",
        id=preset_id,
        factory=factory,
...
def register_memory_backend(backend_id: str, factory: Callable[..., Any], metadata: dict[str, Any] | None = None) -> None:
    get_registry().register(
        kind="memory_backend",
        id=backend_id,
        factory=factory,
