...
def test_ledger_scrubs_absolute_repo_paths(tmp_path) -> None:
    ...
    absolute_file = str(tmp_path / "Agent-Team" / "README.md")
    payload = {
    ...
    assert run_payload["path"] == "${REPO_ROOT}/Agent-Team/README.md"
    assert run_payload["nested"]["items"][0] == "${REPO_ROOT}/Agent-Team/README.md"
    ...
    assert jsonl_payload["path"] == "${REPO_ROOT}/Agent-Team/README.md"
