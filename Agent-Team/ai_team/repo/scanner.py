...
from ai_team.repo.command_detect import DetectedCommand, detect_commands
from ai_team.repo.language_detect import detect_languages
from ai_team.repo.redaction import is_secret_file, safe_text_excerpt
...
def _read_candidate_docs(repo_root: Path, relative_paths: list[Path]) -> tuple[list[RepoDocument], list[str], list[str], list[str]]:
    ...
    for relative in relative_paths:
        ...
        if ".github/workflows/" in posix or posix.startswith("azure-pipelines"):
