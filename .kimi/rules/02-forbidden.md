...
2. Does this introduce provider/workflow/tool specifics into core? (If yes → STOP)
3. Does this bypass policy_engine or tool_protocol? (If yes → STOP)
4. Does this have tests? (If no → write tests)
