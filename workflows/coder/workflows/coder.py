...
class CoderWorkflow(Workflow):
    ...
    def __init__(self, model_registry: Any, tool_registry: Any, policy_engine: Any, ledger: Any) -> None:
    ...
    def execute_step(self, step: Step, context: StepContext) -> StepResult:
        return StepResult(step_id=step.id, success=True, output="Coder sessions execute through the coder runtime.")
